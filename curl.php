...
// $ch = curl_init();
// curl_setopt($ch, CURLOPT_URL,'https://www.skyscrapercity.com/forums/mindanao.1788/');
// curl_setopt($ch, CURLOPT_RETURNTRANSFER,1);
// $output = curl_exec($ch);
// curl_close($ch);
//
// preg_match('~ qid="thread-item-title">[^>]*>(.*?)</a>~si', $output, $dealer_price);
//
// var_dump($dealer_price);

$i = 1;
while ($i < 8) {
    $html = file_get_html('https://www.skyscrapercity.com/forums/mindanao.1788/page-'.$i);
    foreach($html->find('.thread-title--gtm') as $element) {
...
// $html = file_get_html('https://www.skyscrapercity.com/forums/mindanao.1788/');
// foreach($html->find('.thread-title--gtm') as $element) {
//     //echo $element->innerText . '<br>';
